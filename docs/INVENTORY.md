...
| `faq`                                                                      | FAQ                        | —     | FAQ_URL                                     | `/faq`                                                     | todo (G-024)           |
...
| `app/assignment/:assignmentId/edit`                                        | EditAssignment             | true  | ASSIGNMENT_EDIT_URI_FACTORY                 | `/assignments/[id]/edit`                                   | partial (G-007)        |
| `app/assignment/:assignmentId/solutions`                                   | AssignmentSolutions        | true  | ASSIGNMENT_SOLUTIONS_URI_FACTORY            | `/assignments/[id]/solutions`                              | partial (G-002, G-006) |
| `app/assignment/:assignmentId/solution/:solutionId`                        | Solution                   | true  | SOLUTION_DETAIL_URI_FACTORY                 | `/solutions/[id]`                                          | partial (G-001..G-004) |
...
| `app/assignment/:assignmentId/solution/:solutionId/diff/:secondSolutionId` | SolutionSourceCodes        | true  | SOLUTION_SOURCE_CODES_DIFF_URI_FACTORY      | `/solutions/[id]/diff/[otherId]`                           | todo (G-005)           |
...
| `app/shadow-assignment/:shadowId/edit`                                     | EditShadowAssignment       | true  | SHADOW_ASSIGNMENT_EDIT_URI_FACTORY          | `/shadow-assignments/[id]/edit`                            | todo (G-009)           |
...
| `app/exercises/:exerciseId/reference-solution/:referenceSolutionId`        | ReferenceSolution          | true  | REFERENCE_SOLUTION_URI_FACTORY              | `/exercises/[exerciseId]/reference-solutions/[solutionId]` | partial (G-013, G-014) |
...
| `app/group/:groupId/info`                                                  | GroupInfo                  | true  | GROUP_INFO_URI_FACTORY                      | `/groups/[id]?tab=info`                                    | partial (G-012)        |
| `app/group/:groupId/assignments`                                           | GroupAssignments           | true  | GROUP_ASSIGNMENTS_URI_FACTORY               | `/groups/[id]?tab=assignments`                             | partial (G-009, G-010) |
| `app/group/:groupId/students`                                              | GroupStudents              | true  | GROUP_STUDENTS_URI_FACTORY                  | `/groups/[id]?tab=students`                                | partial (G-011)        |
...
| `app/user/:userId/edit`                                                    | EditUser                   | true  | EDIT_USER_URI_FACTORY                       | `/profile/edit` (self), `/users/[id]/edit` (admin)         | partial (G-020..G-022) |
...
| `auth`                         | Login, logout, token refresh, takeover                     | BFF + httpOnly cookies                                                                         | partial (G-020, G-023) |
...
| `exerciseAuthors`              | Exercise author and administrators                         | `exercises/[id]/edit`                                                                          | partial (G-018)        |
...
| `groupExercises`               | Group-specific exercises                                   | `groups/[id]/assignments`                                                                      | partial (G-010)        |
...
| `groups`                       | Group CRUD, hierarchy, membership                          | `groups`                                                                                       | partial (G-008)        |
...
| `pipelineFiles`                | Pipeline files                                             | `pipelines/[id]`                                                                               | todo (G-015)           |
| `pipelines`                    | Pipeline CRUD, structure                                   | `pipelines`                                                                                    | partial (G-016, G-017) |
| `plagiarisms`                  | Plagiarism detection                                       | `solutions/[id]/plagiarisms`                                                                   | done                   |
| `referenceSolutionEvaluations` | Reference solution evaluations                             | `reference-solutions/[id]`                                                                     | partial (G-014)        |
...
| `solutions`                    | Solution CRUD, evaluation                                  | `solutions/[id]`                                                                               | partial (G-001..G-003) |
| `stats`                        | Group/assignment statistics                                | `groups/[id]`                                                                                  | done                   |
| `submission`                   | Active submission state                                    | `assignments/[id]`                                                                             | done                   |
| `submissionEvaluations`        | Evaluation results                                         | `solutions/[id]`                                                                               | partial (G-004)        |
