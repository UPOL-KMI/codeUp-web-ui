...
| `app/exercises/:exerciseId/reference-solution/:referenceSolutionId`        | ReferenceSolution          | true  | REFERENCE_SOLUTION_URI_FACTORY              | `/exercises/[exerciseId]/reference-solutions/[solutionId]` | partial (G-014)        |
